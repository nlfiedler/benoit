 ...
 *
 * $Id: Parameters.java 2003 2005-09-12 04:51:14Z nfiedler $
 *
 ********************************************************************/
...
public class Parameters implements Cloneable {
     ...
     */
    public Parameters(BenoitNumber minX, BenoitNumber maxX,
                      BenoitNumber minY, BenoitNumber maxY) {
    ...
    public void adjustAspect(int width, int height) {
        ...
        if (w.compareTo(h) == 1) {
            // If wider than higher, adjust width.
            ...
            if (Math.abs(imageRatio - regionRatio) > 0.01) {
                // Adjust the aspect only if significantly different.
                h.multiply(imageRatio);
                maxX = BenoitNumber.add(minX, h);
            }

        } else {
            // If higher than wider, adjust height.
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Parameters) {
            ...
            return minX.equals(pobj.minX) && minY.equals(pobj.minY) &&
                maxX.equals(pobj.maxX) && maxY.equals(pobj.maxY);
        } else {
            return false;
        }
    }
    ...
    public String toString() {
        return new String("Parameters=[minX=" + minX +
                          ", maxX=" + maxX +
                          ", minY=" + minY +
                          ", maxY=" + maxY + "]");
    }
